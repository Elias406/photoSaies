...
module.exports.routes = {
  ...
  "GET /admin/clientes": "AdminController.cliente",

  "GET /admin/ver-ordenes/:id": "AdminController.verOrdenes",

  "GET /admin/ver-foto/:idOrden": "AdminController.verFotos",

  "GET /admin/desactivar-cliente/:clienteId":
    "AdminController.desactivarCliente",
  ...
  "GET /admin/desactivar-admin/:idAdmin": "AdminController.desactivarAdmin",

  "GET /admin/activar-admin/:idAdmin": "AdminController.activarAdmin",
